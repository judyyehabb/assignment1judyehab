...
Hero: judy ehab the Warrior
Student ID: 16001422
GitHub account: judyyehabb

A **Stone Golem** bars the way near **Luxor's temples**. It only falls to
the exact blow.

## Your trial

Create `solution.js` in this same folder (`assignment/`). Whennode run with
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By Luxor's temples, the Stone Golem surrenders!"
